#ifndef TERMIOS_SERIAL_USB_H
#define TERMIOS_SERIAL_USB_H
...
namespace Linux
{
class TermiosSerialUSB final : public ISerial
{
  public:
    enum BaudRate
    {
    ...
    bool openComMDB(const char *devicePath, BaudRate baud = BAUD_9600,
                    Parity parity = PAR_SPACEMARK, StopBits stopBits = STOPBITS_ONE);
    bool closeComMDB();
